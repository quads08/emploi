...
import { Reclamant } from '../models/Reclamant';
...
export class RegisterComponent implements OnInit {
  addUSR: FormGroup;
  constructor(
    private apiService: ApiReclamantService,
  ...
  saveReclamant() {
    ...
    this.apiService.addReclamant(reclamant).subscribe(
      data => {
